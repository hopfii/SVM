...
\begin{figure}[H]
	...
	\caption{Die Eingabevektoren werden mittels einer Funktion $\Phi(x)$ in einen höherdimensionalen Raum transformiert. Die transformierten Vektoren sind nach der Transformation durch eine Ebene (blau) linear trennbar.}
